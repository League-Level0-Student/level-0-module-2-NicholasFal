...
public class AnimalFarm {
	...
	void animals() {
		...
		*/			 
			String animalChoice = JOptionPane.showInputDialog("What is your favorite animal?");
			if(animalChoice.equals("cow")) {
				showImage(cowIcon);
			} else {
				if(animalChoice.equals( "duck")) {
					showImage(duckIcon);
				} else {
